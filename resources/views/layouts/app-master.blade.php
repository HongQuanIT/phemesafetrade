...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="styles/css/main.css?v=2.6" />
...
<style>
    ...
    <script>
        document.write("<script type='text/javascript' src='styles/js/daty.js?v=" + Date.now() + "'><\/script>");

    </script>
    <script>
        document.write("<script type='text/javascript' src='styles/js/datyinvest.js?v=" + Date.now() + "'><\/script>");

    </script>
    <script>
        document.write("<script type='text/javascript' src='styles/js/datywith.js?v=" + Date.now() + "'><\/script>");
    ...
    <script src="styles/js/chartjs-plugin-style.js"></script>
    <script>
        document.write("<script type='text/javascript' src='styles/js/dashboard.js'><\/script>");

    </script>
    <script src="styles/js/dashboardearn.js"></script>
    <script src="styles/js/dashboardinvest.js"></script>
    <script src="styles/js/dashboardwith.js"></script>
    <script src="styles/js/dashboardGeneral.js"></script>
    <script>
        svg4everybody();
