            ...
            <div class="container">
                <div class="logo">
                    <a href="{{ route('dashboard.show') }}">
                        <img src="{{ asset('styles/img/header-main.png') }}">
                    </a> <span style="margin-top: 7px; text-transform: uppercase;margin-left: 10px">Investor
                        Dashboard</span>
                </div>
                <div class="profile-wrap">
                    ...
                    <svg class="profile-icon" viewBox="0 0 24.2 24.2">
                        <g clip-path="url(#clip-path)">
                            <ellipse cx="12.1" cy="8.39" rx="2.45" ry="2.7" fill="none"
                                stroke-miterlimit="10" stroke-width="2"></ellipse>
                            <path
                                d="M8.42,18.5h7.36a.7.7,0,0,0,.7-.7h0a3.85,3.85,0,0,0-3.85-3.86H11.57A3.85,3.85,0,0,0,7.72,17.8h0A.7.7,0,0,0,8.42,18.5Z"
                                transform="translate(0 0)" fill="none" stroke-miterlimit="10" stroke-width="2">
                            </path>
                            <path d="M23.2,12.1A11.1,11.1,0,1,1,12.1,1,11.1,11.1,0,0,1,23.2,12.1Z"
                                transform="translate(0 0)" fill="none" stroke-miterlimit="10" stroke-width="2">
                            </path>
                        </g>
                    </svg>
                                ...
                                <svg viewBox="0 0 14.2 14.2">
                                    <g id="setting-icon" viewBox="0 0 14.2 14.2">
                                        ...
                                        <g clip-path="url(#clip-path)">
                                            ...
                                            <path d="M7.1,6A1.08,1.08,0,1,1,6,7.1,1.08,1.08,0,0,1,7.1,6Z"
                                                transform="translate(0 0)" fill="none" stroke-miterlimit="10"></path>
                                        </g>
                                    </g>
                                </svg>
        ...
        <div class="dashboard-menu">
            <div class="container">
                <ul class="dashboard-nav">
                    <li class="active"> <a href="{{ route('dashboard.show') }}">
                            <svg viewBox="0 0 15.6 15.48">
                                <g id="dashboard-icon" viewBox="0 0 15.6 15.48">

                                    <g clip-path="url(#clip-path)">
                                        <rect x="11.99" y="0.5" width="3.11" height="14.48" fill="none"
                                            stroke-miterlimit="10"></rect>
                                        <rect x="6.24" y="3.95" width="3.11" height="11.03" fill="none"
                                            stroke-miterlimit="10"></rect>
                                        <rect x="0.5" y="7.39" width="3.11" height="7.58" fill="none"
                                            stroke-miterlimit="10"></rect>
                                    </g>
                                </g>
                            </svg>
                            My Dashboard </a> </li>
                    <li> <a href="{{ route('investment.show') }}">
                            <svg viewBox="0 0 15.72 13.07">
                                <g id="invest-icon" viewBox="0 0 15.72 13.07">
                                    <rect x="0.5" y="4.66" width="14.72" height="7.91" rx="1.27"
                                        ry="1.27" fill="none" stroke-miterlimit="10"></rect>
                                    <path d="M13.28,6,4.81,2a1.24,1.24,0,0,0-1.6.67L1.89,5.74"
                                        transform="translate(0.12 -1.36)" fill="none" stroke-miterlimit="10"></path>
                    ...
                    <li> <a href="{{ route('deposit.show') }}">
                            <svg viewBox="0 0 12.66 9.1">
                                <g id="investlist-icon" viewBox="0 0 12.66 9.1">
                                    <g>
                                        <line x1="3.5" y1="0.5" x2="12.66" y2="0.5"
                                            fill="none" stroke-miterlimit="10"></line>
                                        <line x1="3.5" y1="4.45" x2="12.66" y2="4.45"
                                            fill="none" stroke-miterlimit="10"></line>
                                        <line x1="3.5" y1="8.6" x2="12.66" y2="8.6"
                                            fill="none" stroke-miterlimit="10"></line>
                                        <line y1="0.5" x2="1.89" y2="0.5" fill="none"
                                            stroke-miterlimit="10"></line>
                                        <line y1="4.45" x2="1.89" y2="4.45" fill="none"
                                            stroke-miterlimit="10"></line>
                                        <line y1="8.6" x2="1.89" y2="8.6" fill="none"
                                            stroke-miterlimit="10"></line>
                                    </g>
                                </g>
                            </svg>
                            ...
                            <svg viewBox="0 0 13.88 17.17">
                                <g id="transaction-icon" viewBox="0 0 13.88 17.17">
                                    <rect x="0.5" y="4.98" width="12.88" height="7.24"
                                        rx="0.9" ry="0.9" fill="none" stroke-miterlimit="10"></rect>
                                    <circle cx="7.04" cy="8.6" r="1.83" fill="none"
                                        stroke-miterlimit="10"></circle>
                                    <polyline points="9.28 14.65 7.04 16.52 4.8 14.65" fill="none"
                                        stroke-miterlimit="10"></polyline>
                                    <polyline points="4.8 2.52 7.04 0.65 9.28 2.52" fill="none"
                                        stroke-miterlimit="10"></polyline>
                                </g>
                            </svg>
                            Transactions </a> </li>
                    <li> <a href="{{ route('referal.show') }}">
                            <svg viewBox="0 0 19.89 26.3">
                                <g id="referrals-icon" viewBox="0 0 19.89 26.3">
                                    ...
                                    <g clip-path="url(#clip-path)">
                                        <ellipse cx="9.94" cy="6.5" rx="5" ry="5.5"
                                            fill="none" stroke-miterlimit="10" stroke-width="2"></ellipse>
                                        <path
                                            d="M2.43,25.3h15a1.43,1.43,0,0,0,1.43-1.43h0A7.86,7.86,0,0,0,11,16H8.86A7.86,7.86,0,0,0,1,23.86H1A1.43,1.43,0,0,0,2.43,25.3Z"
                    ...
                    <li> <a href="{{ route('security.show') }}">
                            <svg viewBox="0 0 13.51 19.38">
                                <g id="security" viewBox="0 0 13.51 19.38">
                                    ...
                                    <g clip-path="url(#clip-path)">
                                        <rect x="1" y="9.31" width="11.51" height="9.07"
                                            rx="2.5" ry="2.5" fill="none" stroke-miterlimit="10"
                                            stroke-width="1.5"></rect>
                                        <path d="M2.13,6.1V5.42a4.43,4.43,0,0,1,8.85,0v4" transform="translate(0 0)"
                                            fill="none" stroke-miterlimit="10" stroke-width="1.5"></path>
                                    </g>
                                </g>
                            </svg>
                            Two Factor </a> </li>
