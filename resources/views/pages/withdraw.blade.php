...
<form method="post"><input type="hidden" name="form_id" value="16601279314656"><input type="hidden" name="form_token" value="39d7ce438b00c054eadfa36979497af0">
...
<label class="payment-item" for="pay-1000">
    <div class="amount-type">
        <span class="payment-type" style="width:50px;">
            <img src="styles/img/pay/1000.svg" style="position: absolute;width: 30px;height: 30px;left: 0;top: -moz-calc((100% - 30px)/2);top: -webkit-calc((100% - 30px)/2);top: calc((100% - 30px)/2);">
...
<label class="payment-item" for="pay-1006">
    <div class="amount-type">
        <span class="payment-type" style="width:50px;">
            <img src="styles/img/pay/1006.svg" style="position: absolute;width: 30px;height: 30px;left: 0;top: -moz-calc((100% - 30px)/2);top: -webkit-calc((100% - 30px)/2);top: calc((100% - 30px)/2);">
...
<label class="payment-item" for="pay-1007">
    <div class="amount-type">
        <span class="payment-type" style="width:50px;">
            <img src="styles/img/pay/1007.svg" style="position: absolute;width: 30px;height: 30px;left: 0;top: -moz-calc((100% - 30px)/2);top: -webkit-calc((100% - 30px)/2);top: calc((100% - 30px)/2);">
...
<label class="payment-item" for="pay-1008">
    <div class="amount-type">
        <span class="payment-type" style="width:50px;">
            <img src="styles/img/pay/1008.svg" style="position: absolute;width: 30px;height: 30px;left: 0;top: -moz-calc((100% - 30px)/2);top: -webkit-calc((100% - 30px)/2);top: calc((100% - 30px)/2);">
...
<label class="payment-item" for="pay-1011">
    <div class="amount-type">
        <span class="payment-type" style="width:50px;">
            <img src="styles/img/pay/1011.svg" style="position: absolute;width: 30px;height: 30px;left: 0;top: -moz-calc((100% - 30px)/2);top: -webkit-calc((100% - 30px)/2);top: calc((100% - 30px)/2);">
...
<label class="payment-item" for="pay-1012">
    <div class="amount-type">
        <span class="payment-type" style="width:50px;">
            <img src="styles/img/pay/1012.svg" style="position: absolute;width: 30px;height: 30px;left: 0;top: -moz-calc((100% - 30px)/2);top: -webkit-calc((100% - 30px)/2);top: calc((100% - 30px)/2);">
